...
public class Project4NumbersofDaysinMonth {
    ...
    private static boolean isLeapYear (int year) // with return type with one parameter method
    {
        boolean b;
        if (year < 1 || year > 9999) {
            b = false;
    ...
    private static void getDaysInMonth(int month, int year)  //with return type with one parameter method
    {
